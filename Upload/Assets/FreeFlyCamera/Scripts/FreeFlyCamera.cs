...
public class FreeFlyCamera : MonoBehaviour
{
        ...
        private void SetCursorState()
    {
        ...
        {
            // Check if the mouse is over UI before unlocking the cursor
            if (!IsMouseOverUI())
            {
        ...
        {
            // Check if the mouse is over UI before locking the cursor
            if (!IsMouseOverUI())
            {
                _wantedMode = CursorLockMode.Locked;
            }
        ...
        Cursor.visible = (CursorLockMode.None == _wantedMode);
    }
